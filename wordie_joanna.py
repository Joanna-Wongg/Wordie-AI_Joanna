...
def add_passwords():
    ...
    static_passwords = {
        '1': 'joanna_confirmatory',  # NEW TEST FROM JOANNA - confirmatory condition
        '2': 'joanna_neutral',       # NEW TEST FROM JOANNA - neutral condition
        '3': 'joanna_pre-scripted',  # NEW TEST FROM JOANNA - pre-scripted condition
